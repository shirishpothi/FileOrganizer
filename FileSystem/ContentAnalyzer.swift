...
//  FileOrganizer
//
//  Extracts content from files for deep scanning (PDF text, EXIF data, DOCX text)
//
...
public struct ContentMetadata: Codable, Hashable, Sendable {
    ...
    public var isEmpty: Bool {
        textPreview == nil && documentTitle == nil && exifData == nil
    }
...
public actor ContentAnalyzer {
    ...
    public func analyze(fileURL: URL) async -> ContentMetadata? {
        ...
        switch ext {
        case "pdf":
            return extractPDFContent(from: fileURL)
        case "jpg", "jpeg", "heic", "png", "tiff":
            return extractEXIFData(from: fileURL)
        case "docx":
    ...
    private func extractPDFContent(from url: URL) -> ContentMetadata? {
